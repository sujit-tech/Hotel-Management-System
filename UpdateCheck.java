...
public class UpdateCheck extends JFrame{
    ...
    public UpdateCheck() throws SQLException {
        ...
        Font font =lblUpdateCheckStatus.getFont();
        Map a=font.getAttributes();
        a.put(TextAttribute.UNDERLINE,TextAttribute.UNDERLINE_ON);
        lblUpdateCheckStatus.setFont(font.deriveFont(a));
        lblUpdateCheckStatus.setBounds(124, 11, 300, 25);
        contentPane.add(lblUpdateCheckStatus);

        ImageIcon i1  = new ImageIcon("C:/Users/ADMIN/IdeaProjects/Hotelms/src/com/icons/nine.jpg");
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    String total = "";
                    Conn c  = new Conn();
                    ResultSet rs2 = c.s.executeQuery("select * from addroom where roomno = "+txt_ID.getText());
                    while(rs2.next()){
