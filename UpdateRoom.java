...
public class UpdateRoom extends JFrame{
    ...
    public UpdateRoom() throws SQLException {
        ...
        ImageIcon i1  = new ImageIcon("C:/Users/ADMIN/IdeaProjects/Hotelms/src/com/icons/seventh.jpg");
        ...
        Font font =lblUpdateRoomStatus.getFont();
        Map a=font.getAttributes();
        a.put(TextAttribute.UNDERLINE,TextAttribute.UNDERLINE_ON);
        lblUpdateRoomStatus.setFont(font.deriveFont(a));
        lblUpdateRoomStatus.setBounds(85, 11, 245, 34);
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    Conn c  = new Conn();
                    ResultSet rs2 = c.s.executeQuery("select * from addroom where roomno = "+txt_Room.getText());
                    while(rs2.next()){
                        txt_Ava.setText(rs2.getString("rstatus"));
                        txt_Status.setText(rs2.getString("cstatus"));
                    }
                }catch(Exception ee){}
            }
        });
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) throws NumberFormatException {
                ...
                try{
                    Conn c = new Conn();
                    String str = "update addroom set cstatus = '"+txt_Status.getText()+"' where roomno = "+txt_Room.getText();
